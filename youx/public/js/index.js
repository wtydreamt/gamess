...
layui.config({
    ...
    tab = layui.bodyTab({
        ...
        url: "../static/admin/layui/json/navs.json" //获取菜单json地址
    });
    ...
    function lockPage() {
        layer.open({
            ...
            '<div class="admin-header-lock-img"><img src="/static/admin/layui/images/face.jpg"/></div>' +
            '<div class="admin-header-lock-name" id="lockUserName">AI管家后台</div>' +
            '<div class="input_btn">' +
    ...
    //右键菜单
    $("#top_tabs").on("contextmenu","li", function (event) {
